...
// Header part
  ...
  #define H_CITA_WASM
    ...
    #define malloc(s) cita_wasm_malloc((s), __FILE_NAME__, __func__, __LINE__)
    #define free(p) cita_wasm_free((p), __FILE_NAME__, __func__, __LINE__)
    #define calloc(n,s) cita_wasm_calloc((n), (s), __FILE_NAME__, __func__, __LINE__)
