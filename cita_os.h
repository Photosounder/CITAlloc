...
// Include the selected platform on every pass so implementation defines take effect
#ifdef CITA_OS_WASM
  #if defined(CITA_OS_IMPLEMENTATION_PART1) && !defined(CITA_WASM_IMPLEMENTATION_PART1)
    #define CITA_WASM_IMPLEMENTATION_PART1
    #define CITA_OS_UNDEF_WASM_IMPLEMENTATION_PART1
  #endif
  #if defined(CITA_OS_IMPLEMENTATION) && !defined(CITA_WASM_IMPLEMENTATION_PART2)
    #define CITA_WASM_IMPLEMENTATION_PART2
    #define CITA_OS_UNDEF_WASM_IMPLEMENTATION_PART2
  #endif
  #include "cita_wasm.h"
  #ifdef CITA_OS_UNDEF_WASM_IMPLEMENTATION_PART1
    #undef CITA_WASM_IMPLEMENTATION_PART1
    #undef CITA_OS_UNDEF_WASM_IMPLEMENTATION_PART1
  #endif
  #ifdef CITA_OS_UNDEF_WASM_IMPLEMENTATION_PART2
    #undef CITA_WASM_IMPLEMENTATION_PART2
    #undef CITA_OS_UNDEF_WASM_IMPLEMENTATION_PART2
  #endif
#endif
